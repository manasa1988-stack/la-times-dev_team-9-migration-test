...
@Component({
    selector: 'scene-5',
    templateUrl: './scene-5.component.html',
    styleUrls: ['../scenes.scss'],
})
export class Scene5Component implements OnInit {
    @Input() sceneHelper;
    ...
    _validate() {
        ...
        this.sceneHelper.model.text = this.sceneHelper.model.text.replace(this.regexp,'');
