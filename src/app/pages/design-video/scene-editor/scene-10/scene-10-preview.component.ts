...
@Component({
    selector: 'scene-10-preview',
    templateUrl: './scene-10-preview.component.html',
    styleUrls: ['./scene-10-preview.component.scss'],
})
export class Scene10PreviewComponent implements OnInit, OnDestroy {
